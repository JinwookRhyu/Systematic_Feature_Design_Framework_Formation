...
for model_name in model_name_list:
    ...
    save_name = "SPA_plots_designed/" + data_name + "_Fit_" + model_name + ".png"
    ...
    if num_nest > 0:
        ...
        ax[2].set_title('RMSE violin plot', fontsize=14)
        ax[3].set_title('MAPE violin plot', fontsize=14)
...
plt.savefig(
    "SPA_plots_designed/" + data_name + "_Violin_RMSE.png")
...
plt.savefig(
    "SPA_plots_designed/" + data_name + "_Violin_MAPE.png")
